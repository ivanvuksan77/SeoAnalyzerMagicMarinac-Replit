              ...
              <div className="mt-2 space-y-3 border-t border-border pt-4">
                ...
                <div className="flex items-start gap-3 py-2">
                  ...
                  <Label htmlFor="checkout-terms" className="text-sm font-normal leading-snug cursor-pointer select-none">
                    ...
                    <Link href="/terms-of-service" className="underline underline-offset-2 hover:text-primary">{t('seo.checkout.termsAcceptTerms')}</Link>
                    {' '}{t('seo.checkout.termsAcceptAnd')}{' '}
                    <Link href="/privacy-policy" className="underline underline-offset-2 hover:text-primary">{t('footer.privacy')}</Link>.
                  </Label>
                </div>
